      ...
      <div className="w-full h-auto mt-4">
        <div className="max-w-[95%] md:max-w-[90%] lg:max-w-[85%] xl:max-w-[80%] 2xl:max-w-[75%] mx-auto">
          ...
          <div className="w-full flex flex-col md:flex-row md:text-lg lg:text-lg xl:text-2xl 2xl:text-3xl gap-3">
            <div className="w-full md:min-w-[350x] max-w-[500px] mx-auto mr-12 border-4 border-orange-300 border-double shadow-lg shadow-gray-300">
              <Image
                src={AboutUs}
                alt="nosotros"
                layout="responsive"
            ...
            <div className="md:w-full md:max-w-none leading-6 lg:leading-8 max-w-[500px] mx-auto">
              <p className="font-semibold  text-slate-500 my-4">La Mila Grosa abrió sus puertas en Enero del 2011.</p>
              <p className="font-semibold  text-slate-500 my-6">
                En constante expasion, contamos con varios locales en distintas provincias.
                Nos puede encontrar en Corrientes, Chaco y Buenos Aires para degustar del menu mas groso de toda la Argentina
            </p>
              <p className="font-semibold  text-slate-500 my-6">
